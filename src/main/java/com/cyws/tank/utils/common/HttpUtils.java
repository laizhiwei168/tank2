...
public class HttpUtils {
	...
	public static String OGIPost(String reqUrl, Map<String, String> params) {
		String url= buildUrl(reqUrl, params);
		List<BasicNameValuePair> nameValuePairList= URLRequest(url);
	...
	public static String sendGetByMozilla(String reqUrl, Map<String, String> params)throws Exception{
		...
		try {
			...
			request.setHeader("Accept-Encoding", "Mozilla/5.0");
			...
			inputStream = new InputStreamReader(response.getEntity().getContent());
	...
	public static List<BasicNameValuePair> URLRequest(String URL) {
		List<BasicNameValuePair> mapRequest = new ArrayList<BasicNameValuePair>();
		...
		for (String strSplit : arrSplit) {
			...
			if (arrSplitEqual.length > 1) {
				mapRequest.add(new BasicNameValuePair(arrSplitEqual[0],
						arrSplitEqual[1]));
				...
				if (arrSplitEqual[0] != "") {
					// 只有参数没有值，不加入
					mapRequest
							.add(new BasicNameValuePair(arrSplitEqual[0], ""));
				}
			}
		}
		return mapRequest;
